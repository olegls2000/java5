...
public class VehoAutoSalon implements lesson10.homework.AutoSalonApi {
    ...
    private lesson10.homework.AbstractVehicle[] parking = new lesson10.homework.AbstractVehicle[PARKING_PLACES];
    ...
    @Override
    public int buyVehicle(lesson10.homework.AbstractVehicle vehicle) {
